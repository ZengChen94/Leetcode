public class Solution {
    public boolean isPossible(int[] nums) {
        ...
        Map<Integer, Integer> appendfreq = new HashMap<>();//This is used to track previous consecutive sequences next elements' values.
        for (int i : nums) 
